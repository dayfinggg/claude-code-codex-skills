...
- Bound background jobs and parallel work, collect failures, and avoid shared mutable state across runspaces unless explicitly synchronized. Keep Codex command output targeted rather than recursively dumping large trees or logs.
