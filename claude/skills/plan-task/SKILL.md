...
Apply the `research` skill when external evidence materially affects the design.
...
Apply the `codebase-design` skill when the plan introduces or materially changes a module interface or seam.
