...
description: Create, edit, review, and verify lean project documentation from repository evidence. Use for README, CONTRIBUTING, architecture docs, ADRs, runbooks, roadmaps, implementation plans, delegation packets, CLAUDE.md, AGENTS.md or AGENTS.override.md, GitHub Copilot instruction files, and documentation drift or information-architecture work.
---
...
Read [document-selection.md](references/document-selection.md) before adding or restructuring docs. Read [agent-instructions.md](references/agent-instructions.md) before editing Claude Code or GitHub Copilot instruction files. Read [roadmap-and-delegation.md](references/roadmap-and-delegation.md) for roadmaps, task packets, and handoffs. Consult [sources.md](references/sources.md) for current vendor rules and documentation frameworks.
...
- Put procedures that have outgrown `CLAUDE.md` into skills under `.claude/skills/`, where the body loads only when used.
