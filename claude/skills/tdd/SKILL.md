...
If the behavior is still materially undefined, resolve it through the plan-task skill before writing tests.
If no stable public seam exists, apply the codebase-design skill before exposing internals only for testing.
