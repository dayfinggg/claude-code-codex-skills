...
Use fan-out and fan-in when lanes are independent and the main session can reconcile their outputs. Examples include separate repository areas, documentation and code evidence, or correctness and security review.
...
4. Keep integration in the main session.
...
Long contexts can lose effective recall as they grow, which supports isolating noisy searches and logs rather than copying them into the main session:
